...
async fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        Commands::Http { url, time, parallel, version, test_type, export, adaptive } => {
        ...
        Commands::HttpServer { port, bind, max_upload_mb, cors } => {
        ...
        Commands::Diagnostics { url, time, parallel, export, skip_dns, skip_quality, skip_topology } => {
            println!("{}", "Starting comprehensive network diagnostics...".green().bold());
